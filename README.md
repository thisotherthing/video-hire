# MatchWithoutLimits
MatchWithoutLimits is a video interviewing platform where candidates face and voice are masked during the interview. 
This will allow the interviewers to understand the candidate's experience and abilities while eliminating their identity from the evaluation process.
